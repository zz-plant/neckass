(() => {
    ...
    function mapElements() {
        const idMap = {
            ...
            feedbackGoodButton: 'feedback-good',
            feedbackBadButton: 'feedback-bad',
            feedbackExportButton: 'feedback-export',
            feedbackCount: 'feedback-count',
            feedbackStatus: 'feedback-status',
            copyAgentSnippetButton: 'copy-agent-snippet',
            apiWaitlistLink: 'api-waitlist-link',
            automationStatus: 'automation-status',
            exportMetricsButton: 'export-metrics',
