...
export function classifyHeadline(headlineText) {
...
export function isIndexEligible(index, { headlines, baseHeadlineCount, filters, normalizedQuery = null, isValidHeadlineIndex }) {
...
export function getEligibleIndexes({ headlines, baseHeadlineCount, filters, isValidHeadlineIndex }) {
