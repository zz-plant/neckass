...
const headlines = [
    "BREAKING: Neckass goes viral for doomscrolling on Twitch, claims he's doing citizen journalism from his couch while snack-checking the chat",
    "Local Neckass live-tweets his own dentist appointment, calls it ‘transparent healthcare for the timeline,’ adds a floss affiliate link",
    "Neckass launches a Substack titled ‘Thoughts I Had in Target’—every post is just a rotisserie chicken review with a five-star cry",
    "BREAKING: Neckass refuses to accept the Terms of Service, declares himself ‘off the grid’ while posting about it",
    "Neckass joins a Discord for focus sessions, never mutes, narrates his snack choices like a cooking stream with chef commentary",
    "Local Neckass attempts to cancel gravity on Change.org, adds ‘ratio incoming’ in the petition description, gets dunked by NASA",
    "Neckass claims his Spotify Wrapped is a diagnostic tool, says lo-fi beats prove he’s enlightened and slightly haunted",
    "BREAKING: Neckass soft-launches his houseplants on Instagram, insists they asked for privacy",
    "Neckass insists he’s ‘laptop optional,’ shows up to remote work with a Nintendo Switch and a dream, tries to screen-share Mario Kart",
    "Local Neckass blames Mercury retrograde for typo in his Venmo request, sends a follow-up request for emotional damages",
    "Neckass starts a GoFundMe to buy Twitter Blue just so he can un-send a tweet from 2014, goal hits $3.12 and a prayer",
    ...
    "Neckass says he’s going ‘phone-free,’ announces it on every platform, schedules reminders to brag and a backup alarm to brag louder",
    "Local Neckass claims his FYP is a degree program, lists TikTok University on LinkedIn",
    "Neckass threatens to move to Canada after getting roasted in a group chat, Googles ‘does Canada have Wi-Fi’ and ‘is poutine vegan’",
    "BREAKING: Neckass launches a BeReal for his cat, still forgets to post on time",
    "Neckass argues with ChatGPT for three hours, screenshots it as proof he’s ‘winning the discourse,’ adds red circles for drama",
    ...
    "Neckass holds a TEDx in a Discord stage channel, charges entry in Roblox gift cards, the talk is titled ‘Hustle Culture but Softer’",
    "Local Neckass calls his mom on FaceTime to prove he’s ‘touching grass,’ never flips the camera",
    "Neckass says he’s starting an intentional community, it’s just a group chat with a color theme and a 12-page vibe constitution",
    "BREAKING: Neckass claims crypto is back because his friend’s cousin said ‘trust,’ remortgages his gaming chair",
    "Neckass refuses to buy a planner, insists his brain has tabs, keeps losing them and blaming Chrome updates",
    "Local Neckass attempts to speedrun his taxes on Twitch, gets banned for spoilers",
    "Neckass forms a BookTok club, first pick is the AirPods user guide, discussion topic is ‘why does mine keep disappearing’",
    "BREAKING: Neckass believes he can manifest Wi-Fi strength by making heart hands at the router",
    "Neckass launches a dating app for people who type in all lowercase, calls it ‘no caps,’ matches based on punctuation anxiety",
    "Local Neckass claims his sleep paralysis demon is an unpaid intern, files for back pay",
    "Neckass starts a newsletter reviewing microwavable meals, rates everything ‘vibes-based’ and ‘emotionally al dente’",
    "BREAKING: Neckass insists he invented the selfie timer, demands royalties from Apple",
    "Neckass opens a virtual museum of unhinged Craigslist posts, tickets cost one cursed JPEG and a nonrefundable sigh",
    "Local Neckass joins a co-working space just to hog the cold brew and say ‘synergy’",
    "Neckass says he’s ‘not an influencer’ while unboxing a ring light and three discount codes, asks chat to smash the bell anyway",
    "BREAKING: Neckass refuses to update his phone, says iOS should adapt to his aura, still uses U2 album",
    "Neckass runs a poll to decide his haircut, ignores the winner, blames bots and ‘algorithmic sabotage’",
    "Local Neckass starts a micro-nation in the comments section, crowns himself Mod-for-Life",
    "Neckass claims he’s biohacking because he switched to oat milk and got a standing desk, starts a podcast called ‘Gut Feelings’",
    "BREAKING: Neckass sells NFTs of his grocery list, brags that someone right-clicked them",
    "Neckass calls customer service to complain about a meme format, asks to speak to the algorithm and requests a manager emoji",
    "Local Neckass brings a ring light to jury duty, says the people deserve content",
    "Neckass joins a backyard pickleball league, live streams every serve with dramatic zooms, calls it ‘court-side content’",
    "BREAKING: Neckass tries to ratio the weather account, blocks the sun for ‘being loud’",
    "Neckass launches a podcast reviewing other podcasts, every episode is just the intro music and a whispered ‘sponsored by vibes’",
    ...
    "Neckass opens a pop-up nap lounge inside a Verizon store, calls it ‘restorative bandwidth,’ charges by the yawn",
    ...
    "Neckass claims he’s ‘off caffeine’ while holding a venti iced espresso with two Red Bulls inside, says it’s just ‘cold brew cosplay’",
    ...
    "Neckass livestreams himself reading the comments section, tears up when someone posts a period, calls it ‘grammatical validation’",
    "Local Neckass uses BeReal as his budgeting app, still overspends on hoodies",
    "Neckass claims his aura is biodegradable, encourages composting compliments, starts a worm bin for his ego",
    "BREAKING: Neckass files a trademark on ‘out of office’ then forgets to set his own",
    "Neckass organizes a silent disco for introverts, everyone just types ‘vibe’ in the chat and rates the silence 8/10",
    "Local Neckass says he’s running for HOA president on a platform of better memes in the bulletin board",
    "Neckass makes a vision board entirely out of screenshots of his own tweets, labels it ‘manifesting engagement’",
    "BREAKING: Neckass opens an Etsy store selling receipts he found in his Uber, calls them vintage PDFs",
    "Neckass gets banned from the library for treating it like a co-working space with ASMR calls, files a noise complaint about himself",
    "Local Neckass installs RGB lights in his shower for ‘emotional patch notes’",
    "Neckass hosts a Zoom wedding for his houseplants, registry is just soil links and one Venmo for emotional support",
    "BREAKING: Neckass refuses to clap on planes, says applause is microtransaction-based now",
    "Neckass creates a new zodiac sign based on screen time, calls himself a ‘full moon scroller’ and requests a custom horoscope",
    "Local Neckass thinks TSA PreCheck is an NFT whitelist, shows his MetaMask at security",
    "Neckass files his taxes in Comic Sans, claims it’s his authentic personal brand, the IRS responds in Papyrus",
    "BREAKING: Neckass pitches a reality show where he judges people’s screen setups, winner gets a cable management kit",
    "Neckass says he’s ‘doing a social experiment’ by only replying in gifs for a week, loses three friends and a cousin, gains a reaction bot",
    "Local Neckass refuses to join the family group text, starts a Discord server with lore documents",
    "Neckass insists he’s allergic to scheduled emails, requests all invites be sent as memes and one carrier pigeon for backup",
