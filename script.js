...
const headlines = [
    ...
    "Local Neckass Submits a Job Application to Space—Lists ‘Professional Daydreamer’ as Experience",
    "BREAKING: Neckass Claims He Can Speak to Squirrels—Squirrels Decline Comment",
    "Neckass Opens a Pop-Up Philosophy Booth: $10 to Hear Him Ask ‘But What Is Money?’",
    "Local Neckass Starts a No-Internet Movement—Promotes It Exclusively Online",
    "BREAKING: Neckass Declares He’s ‘Allergic to Rules’—Breaks Out in Self-Satisfaction",
    "Neckass Patents the Idea of Walking Fast—Demands Joggers Pay Licensing Fees",
    "Local Neckass Tries to Trademark His Laugh—Sends Cease-and-Desist Letters to Comedians",
    "BREAKING: Neckass Declares His Reflection a Public Figure—Requests Paparazzi Respect Its Privacy",
    "Neckass Submits His Grocery List to the Library of Congress as a ‘Historical Document’",
    "Local Neckass Attempts to Crowdsource a Yacht by Manifesting—Still Waiting for Delivery",
    "BREAKING: Neckass Claims He Can Smell Wi-Fi Strength—Demands Router Sommelier Certification",
    "Neckass Hosts Networking Event in a Mirror Maze—No One Else Shows, Calls It ‘Curated’",
    "Local Neckass Declares He Invented the High Five—Offers Low Five as Premium Upgrade",
    "BREAKING: Neckass Launches Weather Channel That Only Reports His Mood",
    "Neckass Opens Pop-Up Nap Lounge—Charges Admission to Watch Him Sleep",
    "Local Neckass Tries to Rename Tuesday to ‘Me-day’—Petition Gains Zero Signatures",
    "BREAKING: Neckass Attempts to Sell Autographs of His Future Self—Claims They’re Rare",
    "Local Neckass Starts Pet Rock Daycare—Says Business Is ‘Surprisingly Well-Behaved’",
    "BREAKING: Neckass Launches Meditation App That Only Plays Recordings of Him Thinking",
    "Neckass Claims He Invented Shadows—Sues the Sun for Copying His Silhouette",
    "Local Neckass Announces Marathon Where Everyone Runs to Compliment Him at the Finish Line",
    "BREAKING: Neckass Declares He’s Carbon Neutral Because He ‘Refuses to Change’",
    "Neckass Attempts to Influence Stock Market by Winking—Says It’s ‘Quantum Finance’",
    "Local Neckass Demands a Holiday in His Honor—Suggests ‘International Appreciation Day for Me’",
    "BREAKING: Neckass Starts a Startup That Sells ‘Pre-Owned Ideas’—Essentially Other People’s Quotes",
    "Neckass Tries to Crowdsource a New Constellation Shaped Like His Signature",
    "Local Neckass Invents Time-Saving Hack: Doing Tasks Tomorrow, Forever",
    "BREAKING: Neckass Claims to Have Discovered a New Color—Refuses to Show Anyone",
    "Neckass Declares He’s Immune to Peer Pressure—Announces It at a Peer Pressure Seminar",
    "Local Neckass Opens a School of Etiquette Where Every Lesson Ends With Him Bowing",
    "BREAKING: Neckass Submits His Resume to History—Labels Himself ‘Future Legend’",
    "Neckass Launches a Pop-Up Museum of Misunderstood Genius—Only Exhibit Is a Mirror",
    "Local Neckass Offers Guided Tours of His Imagination—Tickets Sell to His Imaginary Friends",
    "BREAKING: Neckass Declares All Mornings Should Start at Noon—Cites ‘Personal Sunrise Rights’",
    "Neckass Invents a New Sport Called ‘Cheering for Me’—Undefeated Champion",
    "Local Neckass Attempts to Crowdsource Applause—Sets Up Speakers for Echo",
